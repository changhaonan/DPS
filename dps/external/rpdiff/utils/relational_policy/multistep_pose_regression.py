...
from dps.external.rpdiff.utils import util, path_util
...
from dps.external.rpdiff.utils.torch3d_util import matrix_to_quaternion, quaternion_to_matrix, matrix_to_axis_angle, axis_angle_to_matrix
from dps.external.rpdiff.utils.torch_scatter_utils import fps_downsample

from dps.external.rpdiff.training.train_util import crop_pcd_batch
...
def multistep_regression_scene_combine_sc(
    ...
    if util.exists_and_true(kwargs, 'compute_coverage_scores'):
        ...
        from dps.external.rpdiff.utils.relational_policy.filter_multimodal_placement import remove_redundant_tf
    ...
    if no_sc_score:
        ...
        if with_coll:
            ...
            from dps.external.rpdiff.utils.relational_policy.filter_multimodal_placement import manual_place_success, manual_place_success_gt
    ...
    if util.exists_and_true(kwargs, 'compute_coverage_scores'):
        ...
        from dps.external.rpdiff.utils.relational_policy.filter_multimodal_placement import compute_coverage

...
from dps.external.rpdiff.utils import util, path_util, pcd_aug_util
from dps.external.rpdiff.utils.mesh_util import three_util
from dps.external.rpdiff.utils.mesh_util.inside_mesh import check_mesh_contains

from dps.external.rpdiff.training import train_util
import trimesh

from dps.external.rpdiff.utils.config_util import AttrDict
from meshcat import Visualizer
from typing import List, Tuple, Union
# from dps.external.rpdiff.torch_utils import center_pcd
...
class FullRelationPointcloudPolicyDataset(Dataset):
    ...
    def get_rotation_grid_index(self, rot_mat: np.ndarray, return_closest_mat: bool=False) -> Union[int, Tuple[Union[int, np.ndarray]]]:
        ...
        if self.debug_viz:
            ...
            # from dps.external.rpdiff.utils.fork_pdb import ForkablePdb; ForkablePdb().set_trace()
